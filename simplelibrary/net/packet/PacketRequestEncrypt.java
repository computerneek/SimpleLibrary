...
public class PacketRequestEncrypt implements Packet{
    public final ReadyEncryption encryption;
    private String title;
    private String[] keys;
    private static PacketRequestEncrypt baseInstance;
    public PacketRequestEncrypt(ReadyEncryption e){
        try {
            encryption = e;
            this.title = e.name;
    ...
    public Packet newInstance() {
        return new PacketRequestEncrypt();
    }
    @Override
